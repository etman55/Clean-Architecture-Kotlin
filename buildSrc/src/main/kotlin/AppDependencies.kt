...
object Dependencies {
    ...
    object Kotlin : Libraries {
        ...
        override val components: List<String>
            get() = listOf(stdlib, kotlinReflect)
    }
    ...
    object Network : Libraries {
        ...
        const val rxJavCallAdapter = "com.squareup.retrofit2:adapter-rxjava2:${Version.retrofit}"
        override val components: List<String> = listOf(
            okhttp, loggingInterceptor, retrofit,
            retrofitMoshi, moshi, rxJavCallAdapter
        )
    }
